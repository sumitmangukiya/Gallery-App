package com.example.galleryapp.whatsapp;
...
public class WhatsappImageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GalleryAdapter(WhatsappImageActivity.this, image_list);
        grid_manager = new GridLayoutManager(WhatsappImageActivity.this, 3);
